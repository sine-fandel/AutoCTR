...
from ..preprocessor.feature_column import combined_dnn_input, SparseFeat, VarLenSparseFeat
...
class DIFM (BaseModel) :
	...
	def __init__ (self,
		...
		super (DIFM, self).__init__ ("DIFM", linear_feature_columns, dnn_feature_columns, l2_reg_linear=l2_reg_linear,
